    ...
    <div className="corpo">
      <div className="row">
        <section className="header">
          <h3 className="bold title">Fique no shape comendo o que gosta</h3>
          <div className="video">
            <iframe
              width="560"
              height="315"
      ...
      <div className="row p-md-4 container-ebook">
        ...
        <p className="col-md-6 text-container-ebook">
          ...
          comer o que não gosto ou não vou conseguir desenvolver meus músculos
          ou perder gordura??? Mas então, não é bem assim que funciona. Eu
          estudei muito e aprendi que esse não é o único caminho. Por isso fiz
          nesse livro coloquei todo meu conhecimento para encurtar o seu caminho
          no processo de perda de gordura ou ganho de massa, mostrando que é
          possível Ficar no Shape comendo o que gosta.
        </p>
      </div>
